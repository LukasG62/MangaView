...
$dataNews = ["uid" => 1,
			 ...
			 "banner"=>"https://miro.medium.com/max/3840/1*WO0meGAuY_0ij8wqktvPzA.jpeg",
			 "id" => 3];
...
<div class="container mv-pagebase">
  ...
  <div class="carousel-inner">
	...
	<?php echo mkNews($dataNews, "active")?>
  </div>
</div>
<br />
<button type="button" class="btn btn-secondary btn-lg btn-block">Historique des news</button>
</div>